		...
		<section id="xq">
			...
			<main id="goods_main">
				...
				<article class="ordertype">
					...
					<p class="number">数量：<span>1</span>件</p>
					<p class="price">
...
//				var goods_id = str2.split('=')[1];
				var str51 = str.split("?code")[0];
				var str52 = str.split("&state=STATE")[1];
				var str53 = str52.split("orderGoods1")[0];
				var str50 = str51 + str53;
				console.log(str50);
...
//				changeURLArg('https://a2.t.jiayou9.com/product/info?id=330&debug=1&data_format=1','id',id);
				...
				this.$http.jsonp(changeURLArg('https://a1.t.jiayou9.com/product/info?id=888&debug=1&device_type=3&data_format=1','id',goods_id)).then(function(res){
...
//					console.log(res.body.data[8]);
					...
					var h = document.getElementById("want").getAttribute("href") + str50 + "dingdan?goods_id=" + res.body.data.goods_id;
					$("#want").attr("href",h);
					console.log(h)
