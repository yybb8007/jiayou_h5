						...
						<article class="main_title">
							...
							<div class="title_img title_imgTop">
								<div class="sales salesTop">
									<p class="sales_name"><span class="mid_name1"></span>美妆季 | 超值购<span class="mid_name2"></span></p>
									<!--<p class="message">3.12—3.16全场护肤满300减40</p>-->
								</div>
							</div>
						</article>
						...
						<article class="main_title">
							...
							<div class="title_img title_imgBtm">
								<div class="sales salesBtm">
									<p class="sales_name"><span class="mid_name1" id="mid_name3"></span>海外淘 | 超值购<span class="mid_name2" id="mid_name3"></span></p>
									<!--<p class="message">3.12—3.16全场彩妆满300减40</p>-->
								</div>
							</div>
						</article>
						<article class="main_data">
			...
			ul {
				li {
					.main_title {
						...
						.title_imgTop {
							background: url(http://m.t.jiayou9.com/dist/assets/meizhuang1@2x.png) no-repeat;
							background-size: 100%;
							background-color: #fff;
						}
						.title_imgBtm {
							background: url(http://m.t.jiayou9.com/dist/assets/meizhuang.png) no-repeat;
							background-size: 100%;
							background-color: #fff;
						}
						...
						.title_img {
							...
							.salesTop{
								...
								.sales_name{
									span{
										border-bottom: 4px solid #d56396;
									}
								}
							}
							.salesBtm {
								...
								.sales_name{
									#mid_name3{
										border-bottom: 4px solid #ab9dfc;
									}
								}
							}
						}
