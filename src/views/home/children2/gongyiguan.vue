        ...
        <section id="wrapper" class="sy_main" @click = "callback">
            <div id="gy_banner" class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" v-for="item in data.lunbo"><img v-lazy="item.lunbo_imgurl" alt="" /></div>
                    <!--<div class="swiper-slide" v-for="item in data.lunbo"><img src="../../../../dist/assets/banner.jpg" alt="" /></div>-->
                </div>
