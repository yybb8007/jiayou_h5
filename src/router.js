...
const yaoqingli_download = r => require.ensure([], () => r(require('./views/home/children2/yaoqingli_download')), 'yaoqingli_download') // 邀请有礼--下载页
const yaoqingli_lingquan1 = r => require.ensure([], () => r(require('./views/home/children2/yaoqingli_lingquan1')), 'yaoqingli_lingquan1') // 邀请有礼--领券
