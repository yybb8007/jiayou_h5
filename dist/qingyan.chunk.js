...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "C:\\jishubu\\jiayou_h5\\src\\views\\home\\children3\\children4\\qingyan.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	if (Component.options.functional) {console.error("[vue-loader] qingyan.vue: functional components are not supported with templates, they should use render functions.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-0597fe6c", Component.options)
	  } else {
	    hotAPI.reload("data-v-0597fe6c", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('section', {
	    ...
	    directives: [{
	      name: "lazy",
	      rawName: "v-lazy",
	      value: (_vm.data.dot_ss.dot_imgs),
	      expression: "data.dot_ss.dot_imgs"
	    }]
	  }), _vm._v(" "), _c('img', {
	    directives: [{
	      name: "lazy",
	      rawName: "v-lazy",
	      value: (_vm.data.dot_ss.ss_imgs),
	      expression: "data.dot_ss.ss_imgs"
	    }],
	    attrs: {
	      "ID": _vm.data.dot_ss.data,
	      "target": _vm.data.dot_ss.target
	    }
	  })]), _vm._v(" "), _c('main', {
	    attrs: {
	      "id": "qy_main"
	  ...
	  }, [_c('ul', _vm._l((_vm.data.tsaf), function(item) {
	    return _c('li', {
	      attrs: {
	        "ID": item.data,
	        "target": item.target
	      ...
	      directives: [{
	        name: "lazy",
	        rawName: "v-lazy",
	        value: (item.tsaf_imgs),
	        expression: "item.tsaf_imgs"
	      }],
	      attrs: {
	        "ID": item.data,
	        "target": item.target
	    ...
	    }, [_vm._v("【" + _vm._s(item.tsaf_name) + "】")]), _vm._v(" "), _c('p', {
	      staticClass: "message",
	      attrs: {
	        "ID": item.data,
	        "target": item.target
	      }
	    }, [_vm._v(" " + _vm._s(item.tsaf_ss) + " ")])])]), _vm._v(" "), _c('div', {
	      staticClass: "bottom"
	    }, [_c('p', {
	      staticClass: "eatery",
	      attrs: {
	    ...
	    }), _vm._v("推荐餐馆：" + _vm._s(item.restaurant))]), _vm._v(" "), _c('p', {
	      staticClass: "address",
	      attrs: {
	        "ID": item.data,
	        "target": item.target
	    ...
	    staticClass: "main_message"
	  }, [_c('ul', _vm._l((_vm.data.eot_ss), function(item) {
	    return _c('li', {
	      attrs: {
	        "ID": item.data,
	        "target": item.target
	      }
	    }, [_c('p', [_c('span', [_vm._v(_vm._s(item.eot_ss_name))]), _vm._v("："), _c('span', [_vm._v(_vm._s(item.eot_ss))])])])
	  }))])])])])])])
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-0597fe6c", module.exports)
	  }
	}
