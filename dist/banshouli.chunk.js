...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-769fadd6", Component.options)
	  } else {
	    hotAPI.reload("data-v-769fadd6", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('section', {
	    ...
	    attrs: {
	      "to": "/3/11/banshouli_one"
	    }
	  }, [_c('li', [_c('span', [_vm._v("100元以下")])])]), _vm._v(" "), _c('router-link', {
	    attrs: {
	      "to": "/3/11/banshouli_two"
	    }
	  }, [_c('li', [_c('span', [_vm._v("100-200元")])])]), _vm._v(" "), _c('router-link', {
	    attrs: {
	      "to": "/3/11/banshouli_three"
	    }
	  }, [_c('li', [_c('span', [_vm._v("200元以上")])])])], 1)]), _vm._v(" "), _c('router-view')], 1), _vm._v(" "), _c('li', {
	    ...
	    directives: [{
	      name: "lazy",
	      rawName: "v-lazy",
	      value: (_vm.data[0].banner),
	      expression: "data[0].banner"
	    }],
	    attrs: {
	      "ID": _vm.data[0].data,
	      "target": _vm.data[0].target
	    }
	  })]), _vm._v(" "), _c('article', {
	    staticClass: "main_message"
	  }, [_c('ul', _vm._l((_vm.data[0].goods_detaill_arr), function(item) {
	    return _c('li', {
	      staticClass: "message_three",
	      attrs: {
	        "ID": item.goods_id,
	        "target": item.target
	      }
	    ...
	    }, [_vm._v("　" + _vm._s(item.goods_brief))]), _vm._v(" "), _c('p', {
	      staticClass: "bottom"
	    }, [_vm._v("\n\t\t\t\t\t\t\t\t\t\t\t\t￥"), _c('span', {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-769fadd6", module.exports)
	  }
	}
