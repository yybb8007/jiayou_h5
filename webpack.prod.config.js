...
config.vue = {
	loaders: {
		css: ExtractTextPlugin.extract(
			"style-loader",
			"css-loader!remUnit=65&remPrecision=8", {
				publicPath: "./"
		...
		less: ExtractTextPlugin.extract(
			'vue-style-loader',
			'css-loader!remUnit=65&remPrecision=8!less-loader'
		),
		sass: ExtractTextPlugin.extract(
			'vue-style-loader',
			'css-loader!remUnit=65&remPrecision=8!sass-loader'
		)
	}
};
...
config.plugins = (config.plugins || []).concat([
	...
	new webpack.optimize.CommonsChunkPlugin('vendors', 'vendors.js?v=[chunkhash:8]'), // 提取带hash值的第三方库名称
